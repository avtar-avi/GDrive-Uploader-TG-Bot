...
class Config:
  ...
  if ENV:
    ...
    DATABASE_URL = 'mongodb+srv://avtaravi:avtaravi@cluster0.pcwggwo.mongodb.net/?retryWrites=true&w=majority' # SQL Database URL / Heroku Postgres URL


class Messages:

    START_MSG = "**Hi there {}.**\n__I'm Google Drive Uploader Bot.You can use me to upload any file / video to Google Drive from direct link or Telegram Files.MADE BY @i_avtar __\n__You can know more from /help.__"
